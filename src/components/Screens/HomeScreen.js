        ...
        <div className="container--main">
            <section className="flex-main">
                <div className="text-container">
                    <h1 className="main-text">Hello, my name is <span className="highlight-text">Jorge Vasquez</span></h1>
                ...
                <div className="image-container">
                    <img className="avatar" src="https://i.ibb.co/Tb6SDrv/b686d5c3-9f74-4fa9-b22e-d2111b1b225d.jpg"/>
                </div>
            </section>
        </div>
    )
